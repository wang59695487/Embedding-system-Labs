...
{   unsigned int length,i;
	...
	//	LCD_WR_Data((1<<7)|(1<<6)|(1<<5)|(1<<3));
        ...
        *(__IO uint16_t *) (Bank1_LCD_C)= 0x2A;	
  		*(__IO uint16_t *) (Bank1_LCD_D)= x0>>8;
  		*(__IO uint16_t *) (Bank1_LCD_D)= x0&0xff;
  		//*(__IO uint16_t *) (Bank1_LCD_D)= x1>>8;
  		//*(__IO uint16_t *) (Bank1_LCD_D)= x1&0xff;

  		*(__IO uint16_t *) (Bank1_LCD_C)= 0x2B;	
  		*(__IO uint16_t *) (Bank1_LCD_D)= y0>>8;
  		*(__IO uint16_t *) (Bank1_LCD_D)= y0&0xff;
  		//*(__IO uint16_t *) (Bank1_LCD_D)= y0>>8;
  		//*(__IO uint16_t *) (Bank1_LCD_D)= y0&0xff;
...
//  		*(__IO uint16_t *) (Bank1_LCD_D)= y0>>8;
//  		*(__IO uint16_t *) (Bank1_LCD_D)= y0&0xff;
//  		*(__IO uint16_t *) (Bank1_LCD_D)= y1>>8;
//  		*(__IO uint16_t *) (Bank1_LCD_D)= y1&0xff;
//				
//	
//		*(__IO uint16_t *) (Bank1_LCD_C)= 0x2c;
//		length=y1-y0+1;  
